...
PyObject *
_wrap_PyNs3PointToPointHelper_DisableFlowControl(PyNs3PointToPointHelper *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    
    self->obj->DisableFlowControl();
    Py_INCREF(Py_None);
    py_retval = Py_None;
    return py_retval;
}
...
static PyMethodDef PyNs3PointToPointHelper_methods[] = {
    {(char *) "DisableFlowControl", (PyCFunction) _wrap_PyNs3PointToPointHelper_DisableFlowControl, METH_NOARGS, "DisableFlowControl()\n\n" },
