...
PyObject *
_wrap_PyNs3PhasedArrayModel_GetId(PyNs3PhasedArrayModel *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    uint32_t retval;
...
static PyMethodDef PyNs3PhasedArrayModel_methods[] = {
    ...
    {(char *) "GetId", (PyCFunction) _wrap_PyNs3PhasedArrayModel_GetId, METH_NOARGS, "GetId()\n\n" },
