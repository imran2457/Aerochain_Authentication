...
PyObject *
_wrap_PyNs3CsmaHelper_DisableFlowControl(PyNs3CsmaHelper *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
...
static PyMethodDef PyNs3CsmaHelper_methods[] = {
    ...
    {(char *) "DisableFlowControl", (PyCFunction) _wrap_PyNs3CsmaHelper_DisableFlowControl, METH_NOARGS, "DisableFlowControl()\n\n" },
